...
<asp:Content ID="Content1" ContentPlaceHolderID="content_main" Runat="Server">
    <div>
        ...
        <br />
        <asp:RadioButtonList ID="rbl_status" runat="server" RepeatColumns="2" RepeatDirection="Horizontal" ValidationGroup="careerapplication" SelectedValue='<%#Bind("ques_status")%>'>
        ...
        <br />
        <asp:Dropdownlist ID="ddl_certificate" runat="server" CausesValidation="false" SelectedValue='<%#Bind("ques_certificate")%>'>
        ...
        <br />
        <asp:Dropdownlist ID="ddl_proficiency" runat="server" CausesValidation="false" SelectedValue='<%#Bind("skill_proficiency")%>'>
        ...
        <br />
        <asp:Dropdownlist ID="ddl_experience" runat="server" CausesValidation="false" SelectedValue='<%#Bind("skill_experience")%>'>
        ...
        <br />
        <asp:FileUpload ID="ful_resume" runat="server" FileName='<%#Bind("resume") %>' />
        <br /><br />

        <%--coverletter upload--%>
        <asp:Label ID="lbl_cover" runat="server" Text="Please upload your cover letter." />
        <br />
        <asp:FileUpload ID="ful_cover" runat="server" FileName='<%#Bind("coverletter") %>' />
        <br /><br />

        <%--reason--%>
        <asp:Label ID="lbl_reason" runat="server" Text="Reason:" AssociatedControlID="txt_reason" />
        <br />
        <asp:TextBox ID="txt_reason" runat="server" TextMode="MultiLine" Text='<%#Bind("reason")%>' />

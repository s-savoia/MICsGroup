<%@ Page Title="" Language="C#" MasterPageFile="~/public_master.master" AutoEventWireup="true" CodeFile="careers1-t2-0.1.aspx.cs" Inherits="Default2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content_main" runat="Server">
    ...
    <section>
        <asp:Repeater ID="rpt_data" runat="server" OnItemCommand="subAdmin">
            <HeaderTemplate>
                <table>
                    <tr>
                        <th>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td colspan="2">
                        <asp:Button ID="btn_viewDetails" runat="server" Text="view details" CommandName="ViewDetails" CommandArgument='<%# Eval("Id") %>' />
        ...
        <asp:SqlDataSource ID="sds_popup" runat="server" ConnectionString="<%$ ConnectionStrings:DB_65873_micConnectionString %>" />
    </section>
